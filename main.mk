...
LDFLAGS += -X github.com/xdimedrolx/moly/pkg/platform/buildinfo.version=${VERSION} -X github.com/xdimedrolx/moly/pkg/platform/buildinfo.commitHash=${COMMIT_HASH} -X github.com/xdimedrolx/moly/pkg/platform/buildinfo.buildDate=${BUILD_DATE}
